...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_ortho_4x12_1x2uC(
        ...
        _______, KC_LBRC, KC_RBRC, XXXXXXX, XXXXXXX, KC_PSLS, KC_PAST, KC_4   , KC_5   , KC_6   , KC_PDOT, _______,
    ...
    [_RAISE] = LAYOUT_ortho_4x12_1x2uC(
        ...
        _______, KC_F11 , KC_F12 , KC_SCRL, KC_PAUS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
    ...
    [_ADJUST] = LAYOUT_ortho_4x12_1x2uC(
        ...
        KC_CAPS, OS_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
